 ...
 <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li class="nav-item dropdown">
      	...
      	<%
      		if(aid!=null){ // 관리자로 로그인 되어있으면
      			//관리자 페이지 삽입.
      	%>
      		<li><a href="#" class="nav-link px-2 link-dark">관리자페이지</a></li>  
      	<%
      		}
      	%>
	...
	<%
	if(uid!=null){ // 유저로 로그인 되어있으면
	%> 
	<ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      <div class="col-md-3 text-end">
	  <li class="nav-item dropdown">
	  					<a class="nav-link dropdown-toggle link-dark" href="#"
						id="navbarDropdownMenuLink" role="button"
						data-bs-toggle="dropdown" aria-expanded="false"> 마이페이지 </a>
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li><a class="dropdown-item link-dark" href="../user/userupdate.jsp">회원 정보 수정</a></li>
							<li><a class="dropdown-item link-dark" href="../user/logout.jsp" onclick="return confirm('로그아웃 하시겠습니까?')">로그아웃</a></li>
							<li><a class="dropdown-item link-dark" href="../user/userdelete.jsp">회원 탈퇴</a></li>
							<li><a class="dropdown-item link-dark" href="../user/myboard.jsp">내가 쓴글</a></li>
							<li><a class="dropdown-item link-dark" href="../user/myjobboard.jsp">내 이력서</a></li>
						</ul>
	...
	<%
	}else if (uid==null && aid==null){ //로그인 안되어있으면
	%>
	  <div class="col-md-3 text-end">
