...
public class JobDAO {
	public boolean insert(String jid,String juser,String jtitle,String jdate,String jfile) throws NamingException, SQLException{
		Connection conn = null;
		PreparedStatement pstmt = null;
		
		try {
			String sql = "INSERT INTO jobboard(jid,juser,jtitle,jdate,jfile) VALUES(?,?,?,?,?)";		
	...
	public JobDTO getDetail(String jtitle) throws NamingException,SQLException{
		...
		try {
			...
			JobDTO job = new JobDTO(id,title,user,date,file);
			return job;
		}	
		finally {	
			if(pstmt != null) pstmt.close();
