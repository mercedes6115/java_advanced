...
<form name="idfindscreen" method = "POST">
		...
		<section class = "form-search">
			...
			<div class = "find-phone">
				<label>휴대폰 번호 </label>
				<input type="text" onKeyup = "addHypen(this);" name="uphone" class = "btn-phone" placeholder = "'-'없이 입력">
			</div>
			<br>
	</section>
	<div class ="btnSearch">
	<button class="btn btn-primary text-center mt-2" name="enter" type="submit" onClick="id_search()"> 찾기
	</button>
