...
<table class="table">
  ...
  <tbody>
  	<div class="row" align=center>
		<% 
		ArrayList<BoardDTO> boards =(new BoardDAO()).getmyList(id);
    ...
    <tr>
      ...
      <td><a href="/iboard/boarddetails.jsp?bcon=<%=board.getBcon()%>&buser=<%=board.getBuser()%>&bid=<%=board.getBid()%>"><%= board.getBcon()%> </a> </td>
...
%>
	<div>
 	<a href="/iboard/boardadd.jsp">글쓰기</a>
	</div>
<%
	}else{ //로그인이 안되어있으면
%>		
