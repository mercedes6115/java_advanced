            ...
            <div class="" style="margin-top:150px">
                <div class="rounded d-flex justify-content-center">
                    <div class="col-md-4 col-sm-12 shadow-lg p-5 bg-light">
                        ...
                        <form name = "frm" action="logindb.jsp" method="post">
                            <div class="p-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="uid" class="form-control" placeholder="아이디" required>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text bg-primary"><i
                                ...
                                <button class="btn btn-primary text-center mt-2" type="submit" onclick="fn_submit(); return false;">
                                    로그인
                                </button>
                        ...
                        <div align = "center">
                        <a href="../admin/adminlogin.jsp"><button class="btn btn-warning text-center mt-2" type="submit">
