            ...
            <div class="" style="margin-top:150px">
                <div class="rounded d-flex justify-content-center">
                    <div class="col-md-4 col-sm-12 shadow-lg p-5 bg-light">
                        ...
                        <form name = "frm2" action="adminlogindb.jsp" method="post">
                            <div class="p-4">
                        ...
                        <div align = "center">
                        <a href="../user/login.jsp"><button class="btn btn-primary text-center mt-2" type="submit">
                                
                                    회원로그인
                                </button></a>
                                </div>
                                <a href="adminadd.jsp"><p class="text-center mt-5">
                                    <span class="text-danger">관리자 가입</span>
                                </p></a>
                                <a href="adminFindId.jsp"><p class="text-center text-danger">아이디찾기</p></a>
                    </div>
                </div>
            </div>
        </div>
